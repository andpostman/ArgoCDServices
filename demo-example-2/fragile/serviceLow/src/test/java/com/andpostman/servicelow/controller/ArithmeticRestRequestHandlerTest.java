...
public class ArithmeticRestRequestHandlerTest {
    ...
    public void whenRequestBodyAndRequestHeaderAreNotEmpty_thenReturn200() throws Exception {
        RandomNumber randomNumber = new RandomNumber();
        mockMvc.perform(post("/serviceLow/multiply")
    ...
    @Test
    @DisplayName("Проверка когда тело и хедр задан")
    public void whenRequestBodyNotEmptyButRequestHeaderNotEmpty_thenReturn200() throws Exception {
        RandomNumber randomNumber = new RandomNumber();
        mockMvc.perform(post("/serviceLow/divide")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(randomNumber)))
                .andExpect(status().isOk());
    }
